...
<body>
    <nav class="navbar navbar-dark bg-dark fixed-top">
        <div class="container">
            ...
            <a class="navbar-brand fw-bold" href="/Tugasweb_D">Register - User</a>
        </div>
    </nav>
            ...
            <div class="card text-white bg-dark ma-5 shadow " style="min-width: 25rem;">
                ...
                <div class="card-body">
                    <form action="../process/registerProcess.php" method="post">
                        ...
                        <div class="mb-3">
                            <label for="UGD" class="form-label" >Photo Profile</label>
                    ...
                    <p class="mt-2 mb-0">Have an account? <a href="../login/loginPage.php" class="text-primary">Login here!</a>
                    </p>
                </div>
            </div>
        </div>
