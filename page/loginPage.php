...
<body>
    <nav class="navbar navbar-dark bg-dark fixed-top">
        <div class="container">
            ...
            <a class="navbar-brand fw-bold" href="/Tugasweb_I">Login - User</a>
        </div>
    </nav>
    <div class="bg bg-light text-dark">
        <div class="container min-vh-100 d-flex align-items-center justify-content-center">
            <div class="card text-white bg-dark ma-5 shadow" style="min-width: 25rem;">
                <div class="card-header fw-bold">Login User</div>
                <div class="card-body">
                    ...
                    <p class="mt-2 mb-0">Don't have an account? <a href="../page/registerPage.php" class="text-primary">Click here!</a>
                    </p>
                </div>
            </div>
        </div>
